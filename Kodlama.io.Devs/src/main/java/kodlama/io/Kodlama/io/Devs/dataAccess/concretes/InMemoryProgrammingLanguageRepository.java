...
public void add(ProgrammingLanguage programmingLanguage) throws Exception {
	ProgrammingLanguage[] programminglanguages= {new ProgrammingLanguage(1, "C#"),new ProgrammingLanguage(2, "Java"),new ProgrammingLanguage(3, "Python")};
	
        if (programmingLanguage.getLanguage() == programmingLanguage.getLanguage()) {
